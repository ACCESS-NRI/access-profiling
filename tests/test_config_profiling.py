...
from access.profiling.config_profiling import ConfigProfiling, ProfilingLog
...
class MockConfigProfiling(ConfigProfiling):
    """Test class inheriting from ConfigProfiling to test its methods.
...
@mock.patch("access.profiling.config_profiling.plot_scaling_metrics")
def test_scaling_data(mock_plot, scaling_data):
    """Test the parse_scaling_data and plot_scaling_data methods of ConfigProfiling.
    ...
    config_prof = MockConfigProfiling(paths, ncpus, datasets)
